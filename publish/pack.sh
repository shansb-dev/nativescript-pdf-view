...
#    node_modules/.bin/ncp "$ROOT_DIR"/README.md "$TO_SOURCE_DIR"/README.md
    ...
    #Delete AndroidManifest.xml to prevent it from being included in distribution (in addtion to .aar)
    node_modules/.bin/rimraf platforms/android/AndroidManifest.xml

    node_modules/.bin/rimraf pdf-view.android.ts
    node_modules/.bin/rimraf pdf-view.ios.ts
    node_modules/.bin/rimraf pdf-view.common.ts
